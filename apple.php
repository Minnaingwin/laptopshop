...
<body>
    ...
    <div class="container" id="product-cards">
        <h1 class="text-center" style="font-style: oblique;">APPLE</h1>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    ...
                    <img src="./image/<?php echo $row['item_image']; ?>" alt="">
                        ...
                        <h5 class="card-titel"><?php echo $row['item_name'] ?></h5>
                            ...
                            <a href="appledetail.php?id=<?php echo $row['item_id'];?>" id="viewmorebtn">View Detail</a>
                        </div>
                    </div>
                </div>
            <?php
            ...
            <!-- <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="detaildell.html" id="viewmorebtn">View Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./image/apple3.jpg" alt="">
                    <div class="card-body">
                        <h3>Apple</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
