...
<?php
        if(isset($_POST['Save'])){
          ...
          $new_image = $_POST ['new_image'];
           ...
           if($new_image!=''){
               $sql = "UPDATE item SET item_name=' $itemname',price='$price',ram=' $ram',storage='$storage',battery='$battery', cpu='$cpu',item_image='$new_image' WHERE item_id = $id";
               mysqli_query($con, $sql);
               header("location:delladmin.php");
          }else{
               $sql = "UPDATE item SET item_name=' $itemname',price='$price',ram=' $ram',storage='$storage',battery='$battery', cpu='$cpu', item_image='$old_image' WHERE item_id = $id";
               mysqli_query($con, $sql);
               header("location:delladmin.php");
          }
     }
