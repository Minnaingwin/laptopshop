...
<body>
     ...
     <section id="appledetail">
          <div class="container" id="">
               <h1 style="text-align: center; border-bottom: 2px solid #ed6409; font-style: oblique;">Apple</h1>
               ...
               ?>
                    <div class="col-md-6 py-3 py-md-0">
                         ...
                         <img src="./image/<?php echo $row['item_image']; ?>" width="55%" alt="">
                              <!-- <img src="./image/apple1.jpg" alt="" width="55%"> -->
                    ...
                    <div class="col-md-4 py-3 py-md-0">
                         <div class="form-container">
                              ...
                              <?php
                                   ...
                                   $sql = "INSERT INTO apple(price, item_name, user_name, email, ph, user_address) VALUES ('$price','$itemname','$name','$email','$number','$address')";
