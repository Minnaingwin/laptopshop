                ...
                <h3>Dell Order Lists</h3>
                    <table class="table table-white table-striped">
                        ...
                        <?php
                            ...
                            // $sql ="SELECT user.*,category.cat_name FROM `user` LEFT JOIN category ON user.cat_id=category.cat_id;";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="userupdate.php?user_id=<?php echo $row['user_id'];?>">
                                        <button type="button" class="btn btn-outline-success">Update</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="userdelete.php?user_id=<?php echo $row['user_id'];?>">
                    ...
                    <form method="post">
                        <h3>Dell Item Lists</h3>
                            ...
                            <div class="form-group">
                                <label >Price</label>
                                <input type="text" name="item_price" class="form-control"  placeholder="">
                            </div>
                            <div class="form-group">
                                <label >Ram</label>
                                <input type="text" name="ram" class="form-control"  placeholder="">
                            </div>
                            
                            <div class="form-group">
                                <label >Storage</label>
                                <input type="text" name="storage" class="form-control"  placeholder="">
                            </div>
                            <div class="form-group">
                                <label >Battery</label>
                                <input type="text" name="battery" class="form-control"  placeholder="">
                            </div>
                        
                            <div class="form-group">
                                <label >Cpu</label>
                                <input type="text" name="cpu" class="form-control"  placeholder="">
                            </div>
                            <div class="form-group">
                                <label >Dell Image</label>
                                <input type="file" name="item_image" class="form-control"  placeholder="">
                            </div>
                    ...
                    <?php
                        if(isset($_POST['Save'])){
                            ...
                            $sql = "INSERT INTO item(item_name, price, ram, storage, battery,cpu,item_image) VALUES ('$itemname','$price',' $ram',' $storage',' $battery','$cpu','$image')";
                    ...
                    <thead>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="dellupdate.php?item_id=<?php echo $row['item_id'];?>">
                                        <button type="button" class="btn btn-outline-success">Update</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="delldelete.php?item_id=<?php echo $row['item_id'];?>">
                                        <button type="button"  class="btn btn-outline-danger">Delete</button>
                                    </a>
                                </td>
                            </tr>
