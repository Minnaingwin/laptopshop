...
<body>
    ...
    <div class="container" id="product-cards">
        <h1 class="text-center" style="font-style: oblique;">DELL</h1>
            ...
            <div class="col-md-3 py-3 py-md-0">
                ...
                <img src="./image/<?php echo $row['item_image']; ?>" alt="">
                    ...
                    <h5 class="card-titel"><?php echo $row['item_name'] ?></h5>
                        ...
                        <h5>$<?php echo $row['price'] ?><strike>$800</strike></h5>
                        <a href="detaildell.php?id=<?php echo $row['item_id'];?>" id="viewmorebtn">View Detail</a>
                    </div>
                </div>
            </div>
            <?php
            ...
            <!-- <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="" id="viewmorebtn">View Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./image/dell2.jpg" alt="">
                    <div class="card-body">
                        <h3>Dell</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
