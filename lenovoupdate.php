...
<?php
        if(isset($_POST['Save'])){
          ...
          $new_image = $_POST ['new_image'];
           ...
           if($new_image!=''){
               $sql = "UPDATE lenovo_item SET item_name=' $itemname',price='$price',ram=' $ram',storage='$storage',battery='$battery',item_image='$new_image' WHERE item_id = $id";
               mysqli_query($con, $sql);
               header("location:lenovoadmin.php");
          }else{
               $sql = "UPDATE lenovo_item SET item_name=' $itemname',price='$price',ram=' $ram',storage='$storage',battery='$battery',item_image='$old_image' WHERE item_id = $id";
               mysqli_query($con, $sql);
               header("location:lenovoadmin.php");
          }
     }
