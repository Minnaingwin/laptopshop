                ...
                <h3>Apple Order Lists</h3>
                    <table class="table table-white table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="apupdate.php?user_id=<?php echo $row['user_id'];?>">
                                        <button type="button" class="btn btn-outline-success">Update</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="apdelete.php?user_id=<?php echo $row['user_id'];?>">
                    ...
                    <?php
                        if(isset($_POST['Save'])){
                            ...
                            $sql = "INSERT INTO apple_item(item_name, price, ram, storage, battery,cpu,item_image) VALUES ('$itemname','$price',' $ram',' $storage',' $battery','$cpu','$image')";
                    ...
                    <thead>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="appleupdate.php?item_id=<?php echo $row['item_id'];?>">
                                        <button type="button" class="btn btn-outline-success">Update</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="appledelete.php?item_id=<?php echo $row['item_id'];?>">
                                        <button type="button"  class="btn btn-outline-danger">Delete</button>
                                    </a>
                                </td>
                            </tr>
